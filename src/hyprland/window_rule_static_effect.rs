...
impl EnumConfigForGtk for WindowRuleStaticEffect {
    fn dropdown_items() -> StringList {
        StringList::new(&[
            &t!("hyprland.window_rule.float_on"),
            &t!("hyprland.window_rule.float_off"),
            &t!("hyprland.window_rule.tile_on"),
            &t!("hyprland.window_rule.tile_off"),
            &t!("hyprland.window_rule.fullscreen_on"),
            &t!("hyprland.window_rule.fullscreen_off"),
            &t!("hyprland.window_rule.maximize_on"),
            &t!("hyprland.window_rule.maximize_off"),
            &t!("hyprland.window_rule.fullscreen_state"),
            &t!("hyprland.window_rule.move"),
            &t!("hyprland.window_rule.size"),
            &t!("hyprland.window_rule.center_on"),
            &t!("hyprland.window_rule.center_off"),
            &t!("hyprland.window_rule.pseudo_on"),
            &t!("hyprland.window_rule.pseudo_off"),
            &t!("hyprland.window_rule.monitor"),
            &t!("hyprland.window_rule.workspace"),
            &t!("hyprland.window_rule.no_initial_focus_on"),
            &t!("hyprland.window_rule.no_initial_focus_off"),
            &t!("hyprland.window_rule.pin_on"),
            &t!("hyprland.window_rule.pin_off"),
