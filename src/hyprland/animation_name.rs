...
impl AnimationName {
    ...
    pub fn get_fancy_list() -> [String; 31] {
        [
            t!("hyprland.animation_name.global").to_string(),
            t!("hyprland.animation_name.windows").to_string(),
            t!("hyprland.animation_name.windows_in").to_string(),
            t!("hyprland.animation_name.windows_out").to_string(),
            t!("hyprland.animation_name.windows_move").to_string(),
            t!("hyprland.animation_name.layers").to_string(),
            t!("hyprland.animation_name.layers_in").to_string(),
            t!("hyprland.animation_name.layers_out").to_string(),
            t!("hyprland.animation_name.fade").to_string(),
            t!("hyprland.animation_name.fade_in").to_string(),
            t!("hyprland.animation_name.fade_out").to_string(),
            t!("hyprland.animation_name.fade_switch").to_string(),
            t!("hyprland.animation_name.fade_shadow").to_string(),
            t!("hyprland.animation_name.fade_dim").to_string(),
            t!("hyprland.animation_name.fade_layers").to_string(),
            t!("hyprland.animation_name.fade_layers_in").to_string(),
            t!("hyprland.animation_name.fade_layers_out").to_string(),
            t!("hyprland.animation_name.fade_popups").to_string(),
            t!("hyprland.animation_name.fade_popups_in").to_string(),
            t!("hyprland.animation_name.fade_popups_out").to_string(),
            t!("hyprland.animation_name.fade_dpms").to_string(),
            t!("hyprland.animation_name.border").to_string(),
            t!("hyprland.animation_name.borderangle").to_string(),
            t!("hyprland.animation_name.workspaces").to_string(),
            t!("hyprland.animation_name.workspaces_in").to_string(),
            t!("hyprland.animation_name.workspaces_out").to_string(),
            t!("hyprland.animation_name.special_workspace").to_string(),
            t!("hyprland.animation_name.special_workspace_in").to_string(),
            t!("hyprland.animation_name.special_workspace_out").to_string(),
            t!("hyprland.animation_name.zoom_factor").to_string(),
            t!("hyprland.animation_name.monitor_added").to_string(),
        ]
    }
    ...
    pub fn get_fancy_available_styles(&self) -> Option<Vec<String>> {
        match self {
            AnimationName::Windows | AnimationName::WindowsIn | AnimationName::WindowsOut => {
                Some(vec![
                    t!("hyprland.animation_style.none").to_string(),
                    t!("hyprland.animation_style.slide").to_string(),
                    t!("hyprland.animation_style.slide_with_side").to_string(),
                    t!("hyprland.animation_style.popin").to_string(),
                    t!("hyprland.animation_style.popin_with_percent").to_string(),
                    t!("hyprland.animation_style.gnomed").to_string(),
                ])
            }
            AnimationName::Layers | AnimationName::LayersIn | AnimationName::LayersOut => {
                Some(vec![
                    ...
                    t!("hyprland.animation_style.slide_with_side").to_string(),
                    t!("hyprland.animation_style.popin").to_string(),
                    t!("hyprland.animation_style.fade").to_string(),
                ])
            }
            AnimationName::BorderAngle => Some(vec![
                t!("hyprland.animation_style.none").to_string(),
                t!("hyprland.animation_style.once").to_string(),
                t!("hyprland.animation_style.loop").to_string(),
            ]),
            ...
            | AnimationName::SpecialWorkspaceOut => Some(vec![
                t!("hyprland.animation_style.none").to_string(),
                t!("hyprland.animation_style.slide").to_string(),
                t!("hyprland.animation_style.slide_with_percent").to_string(),
                t!("hyprland.animation_style.slidevert").to_string(),
                t!("hyprland.animation_style.slidevert_with_percent").to_string(),
                t!("hyprland.animation_style.fade").to_string(),
                t!("hyprland.animation_style.slidefade").to_string(),
                t!("hyprland.animation_style.slidefade_with_percent").to_string(),
                t!("hyprland.animation_style.slidefadevert").to_string(),
                t!("hyprland.animation_style.slidefade_with_percent").to_string(),
            ]),
            _ => None,
        }
