...
impl EnumConfigForGtk for WindowRuleProp {
    fn dropdown_items() -> StringList {
        StringList::new(&[
            ...
            &t!("hyprland.window_rule_parameter.pin"),
            &t!("hyprland.window_rule_parameter.not_pin"),
            ...
            &t!("hyprland.window_rule_parameter.fullscreen_state_client"),
            &t!("hyprland.window_rule_parameter.fullscreen_state_internal"),
