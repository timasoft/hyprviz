...
| Эффект | аргумент | Описание |
|----|-----------|---|
| persistent_size | [on] | Для плавающих окон, внутренне хранит их размер. Когда новое плавающее окно открывается с тем же классом и заголовком, восстанавливает сохранённый размер. |
...
> [!IMPORTANT]
> Именованные правила имеют приоритет над анонимными. То есть, правила оцениваются сверху
> вниз, но все именованные правила оцениваются первыми, затем все анонимные.
