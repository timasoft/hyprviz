...
Чтобы воспроизвести "умные отступы" / "без отступов, когда только одно" из других WM/Композиторов, используйте этот код:
...
| gapsin:[x] | Устанавливает отступы между окнами (эквивалентно [Общие->gaps_in](../Variables#general)) | int |
| gapsout:[x] | Устанавливает отступы между окнами и краями монитора (эквивалентно [Общие->gaps_out](../Variables#general)) | int |
| bordersize:[x] | Устанавливает размер границы вокруг окон (эквивалентно [Общие->border_size](../Variables#general)) | int |
...
| layout:[s] | Раскладка, используемая для этого рабочего пространства. | строка |
